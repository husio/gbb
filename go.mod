module github.com/husio/gbb

require (
	github.com/go-surf/surf v0.0.0-20190219081917-3b3aad1efdeb
	...
	github.com/shurcooL/octiconssvg v0.0.0-20171128004830-38b02129bb64
